...
<section class="bg-brand-sand py-10 px-6">
  <div class="max-w-7xl mx-auto">
    <!-- Filter bar -->
    <form method="get" action="/boats" class="bg-white rounded-2xl border border-brand-navy/10 shadow-sm p-4 sm:p-5 grid grid-cols-2 lg:grid-cols-5 gap-3 mb-8">
      ...
      <div class="col-span-2 lg:col-span-5 flex gap-3">
