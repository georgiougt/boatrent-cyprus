...
<div class="flex min-h-screen">
  ...
  <aside id="admin-sidebar" class="fixed lg:static inset-y-0 left-0 z-40 w-64 bg-brand-ink flex flex-col -translate-x-full lg:translate-x-0 transition-transform duration-300">
    ...
    <nav class="flex-1 px-3 py-5 space-y-1">
      ...
      echo adminNav('reels.php', $adminPage, '/admin/reels.php', 'Reels', 'M15 10l4.55-2.27A1 1 0 0121 8.62v6.76a1 1 0 01-1.45.89L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z', $stats['reelsNew']);
      ...
      echo adminNav('import-reels.php', $adminPage, '/admin/import-reels.php', 'Import Reels', 'M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15');
      ?>
